...
@InputType()
class MedicationCreateNestedManyWithoutPatientsInput {
...
export { MedicationCreateNestedManyWithoutPatientsInput as MedicationCreateNestedManyWithoutPatientsInput };
