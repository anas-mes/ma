...
@InputType()
class AppointmentCreateNestedManyWithoutDoctorsInput {
...
export { AppointmentCreateNestedManyWithoutDoctorsInput as AppointmentCreateNestedManyWithoutDoctorsInput };
